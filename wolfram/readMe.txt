...
Notebook 2 processes the output of the C program called coin.out to produce the plots in Sec. 5.9.
...
This directory contains a subdirectory called "output." For all notebooks besides 5, there is nothing more that needs to be said. But when running Notebook 5, I did not want to accidentally overwrite the simulated price histories that were used in the most recent version of the paper.
